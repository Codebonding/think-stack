...
const Facility = () => {
  ...
  const machineData = {
    ...
    batteryComprehensiveTesting: {
      ...
      description: "Pre-dispatch comprehensive testing of battery packs with less than 1 minute cycle time per battery pack. Designed for lithium-ion batteries (CH+ P+ CH- P-) and all series of power batteries. Features calibration mode and can be integrated with Label Printer/Barcode Reader. This device has no inrush current during the working process and will not damage the BMS in the battery pack.",
      specifications: [
        { id: '01', name: 'Voltage Range', details: '0-100V (customizable for higher voltages)' },
        { id: '02', name: 'Voltage Accuracy', details: '1mV, RD ± 0.1% + FS ± 0.1%' },
        { id: '03', name: 'Internal Resistance Range', details: '0-2000 milliohms' },
        { id: '04', name: 'Internal Resistance Accuracy', details: '0.001 milliohms, RD ± 0.1% + FS ± 0.1%' },
        { id: '05', name: 'Charging Current', details: '0-30A' },
        { id: '06', name: 'Charging Current Accuracy', details: '0.001A, RD ± 0.1% + FS ± 0.1%' },
        { id: '07', name: 'Discharge Current Range', details: '0-200A (at highest voltage)' },
        { id: '08', name: 'Continuous Discharge Current', details: '200A' },
        { id: '09', name: 'Discharge Current Accuracy', details: 'RD ± 0.1% + FS ± 0.1%' },
        ...
        { id: '13', name: 'Test Cycle Time', details: '<1 minute per battery pack' },
        { id: '14', name: 'Data Output', details: 'Excel format, MES system interface' }
      ],
      testItems: [
    ...
    description: "The Battery Pack Balancer extends battery lifetime through active charge/discharge balancing. Featuring modular design, hot-pluggable operation, and strong expandability, it provides reliable balancing for various battery applications with advanced protection features and touch controls.",
    features: [
    ...
    specifications: [
      { "id": "01", "name": "Charge/Discharge Current", "details": "Supports up to 20A ± 0.5A" },
      { "id": "02", "name": "Supported Battery Types", "details": "NMC, LFP" },
      { "id": "03", "name": "Battery Strings Supported", "details": "2 to 32 strings of any string number" },
      { "id": "04", "name": "Display & Controls", "details": "Display all cell voltages and touch control" },
      { "id": "05", "name": "Balanced Current", "details": "1 to 20A current adjustable" },
      { "id": "06", "name": "Multi-machine Support", "details": "Support multi-machine serial use" },
      { "id": "07", "name": "Working Voltage", "details": "DC 12V" },
      { "id": "08", "name": "Temperature Protection", "details": "Automatic control at 50°C internal temperature" },
      { "id": "09", "name": "Protection Method", "details": "Instant protection for wrong connection, super series connection, reverse connection" },
      { "id": "10", "name": "Operating Mode", "details": "Support charge equalization or discharge equalization, both modes compatible" }
    ],
  ...
  batteryPackTester: {
    ...
    specifications: [
      { "id": "01", "name": "Input Voltage", "details": "Single-phase ~220V ±10% / 50Hz" },
      { "id": "02", "name": "Charging & Discharging Voltage", "details": "9-99V (±10%)" },
      { "id": "03", "name": "Discharging Method", "details": "Constant current (0.5-20A adjustable)" },
      { "id": "04", "name": "Charging Method", "details": "Constant current & constant voltage (0.5-10A adjustable)" },
      { "id": "05", "name": "Maximum Power", "details": "900W" },
      { "id": "06", "name": "Accuracy", "details": "±0.03" },
      { "id": "07", "name": "Loop Idle Interval", "details": "0-20 mins adjustable" },
  ...
  nickelWireCuttingMachine: {
    ...
    specifications: [
      ...
      { "id": "08", "name": "Compatibility", "details": "Suitable for cutting PVC & Nickel wire" }
    ],
  ...
  heatShrinkMachine: {
    ...
    description: "A Heat Shrink Machine is a versatile tool designed to apply heat to shrinkable materials, providing secure and professional wrapping for cables, battery packs, and other components. It ensures a tight, durable seal, protecting items from moisture, dust, and mechanical damage. Ideal for industrial and commercial use, this machine delivers consistent performance and enhances the durability and appearance of your products.",
    features: [
    ...
    specifications: [
      ...
      { "id": "02", "name": "Conveyor Type", "details": "Mesh with 30Kgs loading capacity" },
      { "id": "03", "name": "Heating Mode", "details": "Far infrared + circulating hot air" },
      { "id": "04", "name": "Power", "details": "8.0 KW" },
      { "id": "05", "name": "Tunnel Size", "details": "600mm x 400mm x 300mm" },
      { "id": "06", "name": "Speed", "details": "0.1-6M/min, Infinitely adjustable" },
      { "id": "07", "name": "Temperature Range", "details": "RT-180°C ±2°C (Closed Loop)" },
  ...
  esdWorkingTables: {
    ...
    specifications: [
      { "id": "01", "name": "Material", "details": "Mild Steel / Aluminum (ESD Safe)" },
      { "id": "02", "name": "Storage", "details": "As per requirement" },
      { "id": "03", "name": "Height", "details": "1800mm (customizable)" },
      { "id": "04", "name": "Table Top Size", "details": "1200 x 600mm (customizable)" },
      { "id": "05", "name": "Usage", "details": "Industrial/Electronics/Battery Assembly" },
      { "id": "06", "name": "Optional Accessories", "details": "Footrest, Universal Socket, Swivel Light, Conductive Bins, Writing Board, Tool Tray, Modular Lock System" }
    ],
  ...
  materialMovementTrolleys: {
    ...
    description: "Stainless steel trolleys with ESD-safe surfaces designed for safe and efficient movement of battery components in industrial environments. Customizable dimensions and load capacities make them ideal for handling sensitive materials in E-vehicle, solar, and energy storage (BESS) applications.",
    applications: [
      "E-Vehicles",
    ...
    specifications: [
      { "id": "01", "name": "Material", "details": "Stainless Steel with ESD Sheet" },
  ...
  spotWeldingJigs: {
    ...
    specifications: [
      { "id": "01", "name": "Compatibility", "details": "Single & Double Side Welding" },
      { "id": "02", "name": "Cell Support", "details": "All Cylindrical Cell Sizes (With/Without Holders)" },
      { "id": "03", "name": "Customization", "details": "Adjustable to Welding Machine Fixtures" },
  ...
  cylindricalCellHolders: {
    ...
    specifications: [
      { "id": "01", "name": "Compatibility", "details": "All Cylindrical Cell Sizes" },
      { "id": "02", "name": "Customization", "details": "Adjustable to any Series/Parallel configuration" },
  ...
  spotWeldingElectrodes: {
    ...
    description: "Spot welding electrodes are specialized components designed for creating strong and reliable welds in battery assembly and metal joining applications. Made from high-conductivity materials like copper alloys, they ensure efficient heat transfer and consistent weld quality.",
    features: [
    ...
    specifications: [
      ...
      { "id": "02", "name": "Lifespan", "details": "10,000 to 15,000 strokes (program dependent)" },
      { "id": "03", "name": "Compatibility", "details": "Customizable to welding machine fixtures" }
    ],
  ...
  cellSortingPins: {
    ...
    description: "Cell Sorting Pins are precision-engineered components used to organize and align battery cells within packs for optimal performance and safety. These pins ensure consistent spacing, prevent short circuits, and enhance thermal management.",
    features: [
    ...
    specifications: [
      { "id": "01", "name": "Type", "details": "For Automatic Cell Sorting Equipment" },
  ...
  pureNickelStrips: {
    ...
    description: "Pure Nickel Strips are essential components in various industrial and electronic applications, known for their exceptional conductivity, corrosion resistance, and durability. Designed to meet the demanding requirements of modern technology.",
    features: [
  ...
  ovenFacility: {
    ...
    description: "The oven facility boasts a robust and spacious chamber with dimensions of 24 x 12 x 8 feet, designed to handle large-scale applications with precision. Utilizing advanced short-wave infrared (IR) heating technology.",
    features: [
    ...
    specifications: [
      ...
      { "id": "03", "name": "Temperature Range", "details": "Ambient +10°C to 250°C" },
      { "id": "04", "name": "Accuracy", "details": "±0.2°C at 120°C" },
      { "id": "05", "name": "Uniformity", "details": "±1.0°C at 120°C" },
      { "id": "06", "name": "Heat-up Time", "details": "Within 15 minutes to 120°C" },
      { "id": "07", "name": "Heater", "details": "40kW" },
      { "id": "08", "name": "Sensor", "details": "Pt 100" },
      { "id": "09", "name": "Insulation", "details": "100mm mineral wool with woven aluminum barrier" }
    ],
  ...
  vacuumPump: {
    ...
    description: "The 3000LPM Belt Drive Vacuum Pump is a high-performance, water-cooled system designed for industrial applications requiring powerful suction and efficiency. Equipped with a 500-liter receiver tank and 7.5HP motor.",
    features: [
      "3000LPM capacity",
      "Water-cooled design",
